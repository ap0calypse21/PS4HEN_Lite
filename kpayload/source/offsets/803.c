...
const struct kpayload_offsets offsets_803 PAYLOAD_RDATA = {
  // data
  ...
  .sceKernelIsGenuineCEX_patch2    = 0x0084D080,
  .sceKernelIsGenuineCEX_patch3    = 0x0089C1E2,
  .sceKernelIsGenuineCEX_patch4    = 0x00A236A0,

  // SceShellCore patches - call nidf_libSceDipsw
  .nidf_libSceDipsw_patch1         = 0x00168D4A,
  .nidf_libSceDipsw_patch2         = 0x00242978,
  .nidf_libSceDipsw_patch3         = 0x0084D0AA,
  .nidf_libSceDipsw_patch4         = 0x00A236CA,
